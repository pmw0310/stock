...
|  | - - 9075 | 장전구분 | String | N |  |  |
|  | - - 1221 | VI발동가격 | String | N |  | 단위: 원 |
|  | - - 1223 | 매매체결처리시각 | String | N |  | HHmmss |
|  | - - 1224 | VI해제시각 | String | N |  | HHmmss |
...
| Request Example |  |  |  |  |  |  |
| {<br>    "trnm": "REG",<br>    "grp_no": "1",<br>    "refresh": "1",<br>    "data": [<br>        {<br>            "item": [<br>                ""<br>            ],<br>            "type": [<br>                "1h"<br>            ]<br>        }<br>    ]<br>} |  |  |  |  |  |  |
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'data': [<br>        {<br>            'values': {<br>                '9001':'005930',<br>                '302':'삼성전자',<br>                '13':'1077818',<br>                '14':'4201',<br>                '9068':'1',<br>                '9008':'101',<br>                '9075':'1',<br>                '1221':'4125',<br>                '1223':'111454',<br>                '1224':'111703',<br>                '1225':'정적',<br>                '1236':'3750',<br>                '1237':'0',<br>                '1238':'+10.00',<br>                '1239':'0.00',<br>                '1489':'+10.00',<br>                '1490':'1',<br>                '9069':'1',<br>                '1279':'+정적'<br>            },<br>            'type':'1h',<br>            'name':'VI발동/해제',<br>            'item':'005930'<br>        }<br>    ],<br>    'trnm':'REAL'<br>} |  |  |  |  |  |  |
