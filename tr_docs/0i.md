...
|  | - item | 실시간 등록 요소 | String | N | 100 | MGD: 원/g, MGU: $/온스,소수점2자리 |
...
|  | - - 25 | 전일대비기호 | String | N |  | 1:상한, 2:상승, 3:없음, 4:하한, 5:하락 |
|  | - - 11 | 전일대비 | String | N |  | 단위: 원, 부호가 포함된 숫자 |
|  | - - 12 | 등락율 | String | N |  | 단위: %, 부호 포함 소수점 둘째 자리까지 포맷된 백분율 |
| Request Example |  |  |  |  |  |  |
| {<br>    "trnm": "REG",<br>    "grp_no": "1",<br>    "refresh": "1",<br>    "data": [<br>        {<br>            "item": [<br>                "MGD"<br>            ],<br>            "type": [<br>                "0I"<br>            ]<br>        }<br>    ]<br>} |  |  |  |  |  |  |
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'data': [<br>        {<br>            'values': {<br>                '10': '-337782',<br>                '25': '5',<br>                '11': '-1674',<br>                '12': '-0.49'<br>            },<br>            'type': '0I',<br>            'name': '국제금환산가격',<br>            'item': 'MGU'<br>        }<br>    ],<br>    'trnm': 'REAL'<br>} |  |  |  |  |  |  |
