...
|  | - item | 실시간 등록 요소 | String | N |  | 거래소별 종목코드<br>(KRX:039490,NXT:039490_NX,SOR:039490_AL) |
|  | - values | 실시간 값 리스트 | LIST | N |  |  |
|  | - - 21 | 호가시간 | String | N |  | HHmmss |
|  | - - 131 | 시간외매도호가총잔량 | String | N |  | 단위: 1주 |
|  | - - 132 | 시간외매도호가총잔량직전대비 | String | N |  | 단위: 1주, 부호가 포함된 숫자 |
|  | - - 135 | 시간외매수호가총잔량 | String | N |  | 단위: 1주 |
|  | - - 136 | 시간외매수호가총잔량직전대비 | String | N |  | 단위: 1주, 부호가 포함된 숫자 |
| Request Example |  |  |  |  |  |  |
| {<br>    "trnm": "REG",<br>    "grp_no": "1",<br>    "refresh": "1",<br>    "data": [<br>        {<br>            "item": [<br>                "005930"<br>            ],<br>            "type": [<br>                "0E"<br>            ]<br>        }<br>    ]<br>} |  |  |  |  |  |  |
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'trnm': 'REAL',<br>    'data': [<br>        {<br>            'type': '0E',<br>            'name': '주식시간외호가',<br>            'item': '005930',<br>            'values': {<br>                '21': '165208',<br>                '131': '43955',<br>                '132': '+156',<br>                '135': '0',<br>                '136': '0'<br>            }<br>        }<br>    ]<br>} |  |  |  |  |  |  |
