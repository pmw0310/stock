...
|  | - - 202 | 매도수량 | String | N |  | 단위: 1주 |
|  | - - 204 | 매도금액 | String | N |  | 단위: 원 |
|  | - - 206 | 매수수량 | String | N |  | 단위: 1주 |
|  | - - 208 | 매수금액 | String | N |  |  |
|  | - - 210 | 순매수수량 | String | N |  |  |
...
| Request Example |  |  |  |  |  |  |
| {<br>    "trnm": "REG",<br>    "grp_no": "1",<br>    "refresh": "1",<br>    "data": [<br>        {<br>            "item": [<br>                "005930"<br>            ],<br>            "type": [<br>                "0w"<br>            ]<br>        }<br>    ]<br>} |  |  |  |  |  |  |
| Response Example |  |  |  |  |  |  |
| #요청<br>{<br>    'trnm': 'REG',<br>    'return_code': 0,<br>    'return_msg': ''<br>}<br><br>#실시간 수신<br>{<br>    'data': [<br>        {<br>            'values': {<br>                '20': '113442',<br>                '10': '-60200',<br>                '25': '5',<br>                '11': '-100',<br>                '12': '-0.17',<br>                '13': '128152628',<br>                '202': '0',<br>                '204': '0',<br>                '206': '8043',<br>                '208': '483',<br>                '210': '8043',<br>                '212': '483',<br>                '213': '0',<br>                '211': '0'<br>            },<br>            'type': '0w',<br>            'name': '종목별프로그램매매',<br>            'item': '005930'<br>        }<br>    ],<br>    'trnm': 'REAL'<br>} |  |  |  |  |  |  |
