...
/**
 * 키움증권 주식 매도주문 (kt10001) 요청 DTO 클래스입니다.
 */
export class Kt10001RequestDto {
  /**
   * 국내거래소구분 (KRX, NXT, SOR)
   */
  @IsString()
  ...
  /**
   * 매매구분
   * 0: 보통, 3: 시장가, 5: 조건부지정가, 6: 최유리지정가, 7: 최우선지정가,
...
/**
 * 키움증권 주식 매도주문 (kt10001) 응답 DTO 클래스입니다.
 */
export class Kt10001ResponseDto extends KiwoomBaseResponseDto {
  /**
   * 주문번호
   */
  @IsString()
